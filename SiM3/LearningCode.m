...
folder = 'D:\Line-Center\DNN-Model-for-Fault-Diagnosis-of-Bearing\SiM3\Z1'
...
options = trainingOptions('sgdm', 'LearnRateSchedule', 'piecewise', 'InitialLearnRate', 1e-5, 'MaxEpochs', 30, 'Shuffle', 'every-epoch', 'ValidationData', imdsTest, 'ValidationFrequency', 50, 'Verbose', false, 'ExecutionEnvironment', 'gpu', 'Plots', 'training-progress', 'MiniBatchSize', 64); 
...
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
%% Train network
[net_z1,info_z1] = trainNetwork(imdsTrain,layers,options);