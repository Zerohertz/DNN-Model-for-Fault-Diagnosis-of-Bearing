...
folder = 'D:\Line-Center\DNN-Model-for-Fault-Diagnosis-of-Bearing\v43hmbwxpm-2\28\LearningData'
...
%     maxPooling2dLayer([2 2],"Name","maxpool_3")
...
options = trainingOptions('adam', 'LearnRateSchedule', 'piecewise', 'InitialLearnRate', 0.001, 'MaxEpochs', 30, 'Shuffle', 'every-epoch', 'ValidationData', imdsTest, 'ValidationFrequency', 30, 'Verbose', false, 'ExecutionEnvironment', 'gpu', 'Plots', 'training-progress', 'MiniBatchSize', 128); 
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
disp('training options is set')
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
%% Train network
[net_28,info_28] = trainNetwork(imdsTrain,layers,options);